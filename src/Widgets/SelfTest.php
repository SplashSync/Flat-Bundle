...
namespace Splash\Connectors\Flat\Widgets;
...
class SelfTest extends AbstractStandaloneWidget
{
     ...
     * Class Constructor
     *
     * @param FlatConnector $connector
     */
    public function __construct(private FlatConnector $connector)
    {
    }
    ...
    private function buildIntroBlock(): void
    {
        //====================================================================//
        // Into Text Block
        $this->blocksFactory()->addTextBlock("This widget summarize SelfTest of your Flat Connector Config");
    }
